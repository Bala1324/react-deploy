...
const BookTable = () => {
    ...
    const bookTable = () => {
        ...
        if (selection.location && selection.size && selection.time && bookingDate) {
            axios.post(url.SERVER_URL + "/api/v1/table/table-book", { date: bookingDate, location: selection.location, time: selection.time, person: selection.size, email: 'balachandiran1324@gmail.com' }).then((res) => {
                            ...
                            <div>
                                <Row noGutters className="text-center">
                                    <Col>
                                        ...
                                        <i className="fas fa-pizza-slice thank-you-pizza-2">{msg.message} </i>
