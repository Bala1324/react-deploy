...
const Addfood = () => {
    ...
    const postDatas = () => {
        ...
        axios.post(url.SERVER_URL + "/api/v2/food/add", fooditem, {
            headers: { "token": token }
        }
        )
            .then((Response) => {
    ...
    const categorys = () => {
        axios.get(url.SERVER_URL + "/api/v2/food/getfoodcategory")
            .then((res) => {
    ...
    return (
        ...
        <section className="form my-4 mx-5">
            ...
            <form >
                ...
                <div className="from-row">
                    <div className="col-lg-7">
                        <input type="file" value={fooditem.foodImage} name="foodImage" onChange={handleChange} className="form-control" />
                    </div>
                </div>
                <div className="from-row">
                    <div className="col-lg-7" >
