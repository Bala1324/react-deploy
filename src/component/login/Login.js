...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(url.SERVER_URL + '/api/v1/user/loginpage', { userName, password })
      ...
      console.log("ress", response.data.data.uuid)
  ...
  const resetpassword = async () => {
    ...
    const updatePassword = await axios.post(url.SERVER_URL + "/api/v1/user/forgetPassword", { email, password })
  ...
  const checkemail = async () => {
    ...
    const registeremail = await axios.post(url.SERVER_URL + "/api/v1/user/check-email", { email })
  ...
  const onLoginSuccess = async (res) => {
    ...
    const registeremail = await axios.post(url.SERVER_URL + "/api/v1/user/check-email", { email: googleEmail })
    console.log("emaillll", registeremail.data.status)
    console.log("sucess")
    if (registeremail.data.status == true) {
      console.log("signin")

      const response = await axios.post(url.SERVER_URL + '/api/v1/user/loginpage', { userName: given_name, password: "Google@1324", logintype: "google" })
      ...
      if (text) {
        const response = await axios.post(url.SERVER_URL + '/api/v1/user/verify-number', { number: text })
        ...
        if (otp) {
          ...
          if (otpData == otp) {
            Swal.fire(
              ...
              const response = await axios.post(url.SERVER_URL + '/api/v1/user/signupPage',
  ...
  const responseFacebook = async (response) => {
    ...
    if (response.accessToken) {
      ...
      const registeremail = await axios.post(url.SERVER_URL + "/api/v1/user/check-email", { email: facebookemail })
      console.log("emaillll", registeremail)
      if (registeremail.data.status) {

        const response = await axios.post(url.SERVER_URL + '/api/v1/user/loginpage', { userName: name, password: "Facebook@1324", logintype: "facebook" })
        console.log("loginpage", response)
      } else {
        const response = await axios.post(url.SERVER_URL + '/api/v1/user/signupPage',
